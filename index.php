...
<html lang="en">
    ...
    <body>
        ...
        <div class="container mt-3">
            <div class="row">
                ...
                <h1 class="display-3">HTML - RANKING with bootstrap</h1>
                <p class="lead">LATIFA XI RPL</p>
            </div>
    ...
    <footer class="bg-info text-white text-center p-2 my-4">
      <p>Copyright © latifaa | Happy coding^^</p>
    </footer>
